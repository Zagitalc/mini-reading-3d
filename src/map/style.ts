...
export function mapStyle():StyleSpecification{
 ...
 {id:'building-overview',type:'fill-extrusion',...source,maxzoom:14,filter:['all',filter('building'),['==',['get','landmark'],'']],paint:{'fill-extrusion-color':['match',['get','colour'],0,'#b6866d',1,'#b89d86',2,'#c8bfaa',3,'#8da5a5',4,'#b98b7a',5,'#c5b394',6,'#99aa9d','#c1a18e'],'fill-extrusion-height':['get','height'],'fill-extrusion-opacity':1}},
